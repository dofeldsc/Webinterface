...
if (isset($_POST["editType"])) {
    ...
    switch ($_POST["editType"]) {
        case "house_space":
            $hSpace = $_POST["hSpace"];
            $sql = "UPDATE houses SET `space_data`='" . $hSpace . "' WHERE houses.`id` = '" . $hID . "'";
            $db_link->query($sql);
            message($lang['house'] . ' ' . $lang['updated'], "info");
            break;
        ...
        case "house_cont":
            $hCont = $_POST["hCont"];
            $sql = "UPDATE houses SET `container`='" . $hCont . "' WHERE houses.`id` = '" . $hID . "'";
            $db_link->query($sql);
            message($lang['house'] . ' ' . $lang['updated'], "info");
            break;
...
<div class="col-md-8" style="float:right; padding-top:20px;">
    ...
    echo '<li class="active"><a href="#house_space" data-toggle="tab">Arma-Inv</a></li>';
    echo '<li><a href="#house_inv" data-toggle="tab">T-Inv</a></li>';
    echo '<li><a href="#house_cont" data-toggle="tab">Kisten</a></li>';
    echo '</ul>';
    ?>
    <div id="myTabContent" class="tab-content">
        <div class="tab-pane fade active in well" id="house_space">
            <h4 style="centred">Arma-Inv</h4>
            <?php
                echo "<textarea class='form-control' readonly rows='5' style='width: 100%' id='house_space' name='house_space'>" . $house->space_data . "</textarea>";
            ?>
            <br>
            <?php if ($_SESSION['permissions']['edit']['houses']) { ?>
            <a data-toggle="modal" href="#edit_house_space" class="btn btn-primary btn-xs" style="float: right;">
                <i class="fa fa-pencil"></i>
            </a>
            <?php } ?>
            <br>
        </div>
        <div class="tab-pane fade well" id="house_inv">
            <h4 style="centred">T-Inv</h4>
            <?php
        ...
        <div class="tab-pane fade well" id="house_cont">
            <h4 style="centred">Kisten</h4>
            <?php
                echo "<textarea class='form-control' readonly rows='5' style='width: 100%' id='house_cont' name='house_cont'>" . $house->container . "</textarea>";
            ?>
            <br>
            <?php if ($_SESSION['permissions']['edit']['houses']) { ?>
...
<div class="modal fade" id="edit_house_space" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    <span class="glyphicon glyphicon-pencil"></span> Bearbeite Arma-Inv
                </h4>
            </div>
                <form method="post" action="<?php echo $settings['url'] . "editHouse/" . $hID ?>" role="form">
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="hidden" name="editType" value="house_space"/>

                            <div class="row">
                                    <textarea class="form-control" rows="10"
                                              name="hSpace"><?php echo $house->space_data; ?></textarea>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">
                    <span class="glyphicon glyphicon-pencil"></span> Bearbeite T-Inv
                </h4>
            </div>
                <form method="post" action="<?php echo $settings['url'] . "editHouse/" . $hID ?>" role="form">
                    <div class="modal-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">
                    <span class="glyphicon glyphicon-pencil"></span> Bearbeite Kisten
                </h4>
            </div>
                <form method="post" action="<?php echo $settings['url'] . "editHouse/" . $hID ?>" role="form">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="row">
                                    <textarea class="form-control" rows="10"
                                              name="hCont"><?php echo $house->container; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
...
<div class="modal fade" id="del_house" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title"><span class="glyphicon glyphicon-pencil"></span> Haus löschen?
                </h4>
            </div>
            <form method="post" action="<?php echo $settings['url'] . "editHouse/" . $hID ?>" role="form">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <center><h4>Bist du sicher?</h4></center>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
