        ...
        if ($settings['lifeVersion'] == 3) {
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-lg-offset-1">
                    <div class="panel panel-primary panel-infos">
                        <div class="panel-heading panel-infos">
                            <div class="row">
                                <div class="col-xs-2" style="font-size: 5em;">
                                ...
                                <div class="col-xs-10">
                                    <div class="row">
                                        <div class="col-xs-10 col-xs-offset-2 text-right">
                                            <?php
                                            $sql = "SELECT `name` FROM `players` WHERE first_login !='To Old' ORDER BY `first_login` DESC LIMIT 1;";
                                            $result_of_query = $db_link->query($sql);
                                            while ($row = mysqli_fetch_assoc($result_of_query)) {
                                                echo "<h2>" . $row["name"] . "</h2>";
                                            };
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <?php
                                        ...
                                        echo "<h1>" . number_format($total_records,0, ",", ".") . "</h1>";
                                    ?>
                                    <div>Spieler</div>
                                </div>
                            </div>
